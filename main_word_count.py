...
pickle.dump(word_freq_dict, open("/Volumes/GoogleDrive/My Drive/UIUC/PyCharm/Word_V_World/data/word_freq_dict.p", "wb"))

# save all pair list to pickle file
all_pair_list = get_all_pair_list()
pickle.dump(all_pair_list, open("/Volumes/GoogleDrive/My Drive/UIUC/PyCharm/Word_V_World/data/all_pair_list.p", "wb"))


# get total words in wiki
total_tokens = get_total_token_count(word_freq_dict)
pickle.dump(total_tokens, open("/Volumes/GoogleDrive/My Drive/UIUC/PyCharm/Word_V_World/data/total_tokens.p", "wb"))
